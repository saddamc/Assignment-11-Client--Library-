    ...
    const navLinks = <>
        ...
        {user?.email ?
            <>
                ...
                <li className=""> <NavLink to="/my-books">My Books</NavLink> </li>
                ...
                <div className="navbar-start">
                    ...
                    <div>
                        <a className="text-4xl font-extrabold font-Lobster">
                            <Link to="/"><img className="bg-red-500 w-[250px] rounded-md p-1  " src={logo} alt="" /></Link>
                        </a>
                    </div>
                </div>
...

                    {
                        ...
                        <div to="/login">
                            <div className="flex items-center">
                                ...
                                <Link to="/login"><button onClick={handleLogout} className="login-button ml-2 p-2 rounded-md text-white font-semibold bg-red-500 text-sm ">Sign Out</button></Link>
                            </div>
                        </div>
